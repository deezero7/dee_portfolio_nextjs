...
const projectsData: ProjectInterface[] = [
  {
    ...
    description: [
      ...
      "Player data includes profile picture, gems, gold, XP, level, and more",
      ...
      "Regex-based validation for email and password formats",
      "Mongoose for schema definition and database connection",
      "Modular routing structure for scalability",
      "Forgot password reset functionality",
      "Profile picture upload using multipart forms (Multer)",
      "Frontend built with Next.js (web) and Unity3D (Android) sharing the same backend",
    ],
